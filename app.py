...
#################################################
###### data display - comparative analysis ######
#################################################
...
selected_countries = st.multiselect(
    ...
    options = df_annualIndicators['Country'].unique(),
    default = [selected_country, "United States"] # USA as default
)
selected_years = st.multiselect(
    "Select Years to Compare",
    options = df_annualIndicators['Year'].unique(),
    default = ["2015", "2016", "2017", "2018", "2019", "2020", "2021", "2022", "2023"] # all years as default
)
...
# create tabs for the indicators
